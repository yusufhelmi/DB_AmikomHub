...
@section('page_subtitle', 'Daftar partner pendukung AmikomEventHub.')
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y border-t">
                ...
                <tr class="hover:bg-slate-50/50 transition">
                    ...
                    <td class="px-8 py-6">
                        <img src="{{ $partner->logo_url }}" alt="Logo {{ $partner->name }}" class="w-16 h-16 rounded-xl object-cover shadow-sm border border-slate-100">
                    </td>
                    <td class="px-8 py-6">
                    ...
                    <td class="px-8 py-6">
                        <div class="flex gap-2">
                            <a href="#" class="p-2.5 bg-indigo-50 text-indigo-600 rounded-xl hover:bg-indigo-600 hover:text-white transition" title="Edit">
